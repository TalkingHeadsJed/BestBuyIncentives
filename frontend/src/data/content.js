...
export const NAV_LINKS = [
  ...
  { label: "Sales Resources", to: "/articles" },
  { label: "FAQ", to: "/faq" },
...
export const PROGRAMS = [
  {
    ...
    image: "/images/luxury-getaway-ad.png",
...
export const INDUSTRIES = [
  ...
  },
  {
    ...
    desc: "Lift average order value and rescue abandoned carts. A getaway with the purchase turns one-time buyers into repeat customers.",
    metric: "+29% repeat purchase",
  },
  {
    name: "Travel Clubs",
    desc: "Sell more memberships and renewals. A premium incentive gives prospects the push to join today and members a reason to stay.",
    metric: "+33% membership sales",
  },
  {
    name: "Health Clubs",
    desc: "Close membership tours on the spot and cut cancellations. A vacation reward beats another free month on price and appeal.",
    metric: "+26% membership close",
  },
  {
    name: "Employee Rewards",
    desc: "Motivate performance and keep top talent. A dream getaway outshines a gift card and builds loyalty money can't buy.",
